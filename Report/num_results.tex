...
pick $i=2$, which should be enough for a `true error' indication. We will write $\tilde U_k$ for the discrete solution found on the twice uniformly refined triangulation of $\T_k$.
...
solution $u$ has a peak of value $1$ centered around $(\frac{1}{2}, \frac{1}{2})$ and is again very smooth. 
